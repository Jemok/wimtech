 			...
 			<div class="col-md-8 products-single">
            				<div class="col-md-5 grid-single">
            						<div>
            									...
            									<div class="thumb-image"> <img src="{{ asset('uploads/'.$product->product_image)}}" data-imagezoom="true" class="img-responsive" alt=""/> </div>
            				...
            				<div class="col-md-4 col-md-offset-2 single-text">
            					<div class="details-left-info simpleCart_shelfItem">
            						<h3>{{$product->product_name}}</h3>

            						<div class="price_single">

            							<span class="actual item_price">Kshs {{$product->product_price}}</span>
            						</div>
            						<h2 class="quick">Quick Overview</h2>
            						<p class="quick_desc">{{$product->product_description}}</p>
